...
class FarmAssets:
    ...
    neon_dirt = pygame.image.load(
        os.path.join("assets", "farm", "ground", "neon-dirt", "neon-dirt.png")).convert_alpha()
    neon_dirt_lux = pygame.image.load(
        os.path.join("assets", "farm", "ground", "neon-dirt", "light.png")).convert_alpha()
